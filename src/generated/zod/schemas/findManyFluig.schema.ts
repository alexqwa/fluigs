...
export const FluigFindManySelectSchema: z.ZodType<Prisma.FluigSelect> = z.object({
...
export const FluigFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    status: z.boolean().optional(),
    product: z.boolean().optional(),
    code: z.boolean().optional(),
...
export const FluigFindManySchema: z.ZodType<Prisma.FluigFindManyArgs> = z.object({ select: FluigFindManySelectSchema.optional(), include: z.lazy(() => FluigIncludeObjectSchema.optional()), orderBy: z.union([FluigOrderByWithRelationInputObjectSchema, FluigOrderByWithRelationInputObjectSchema.array()]).optional(), where: FluigWhereInputObjectSchema.optional(), cursor: FluigWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FluigScalarFieldEnumSchema, FluigScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FluigFindManyArgs>;

export const FluigFindManyZodSchema = z.object({ select: FluigFindManySelectSchema.optional(), include: z.lazy(() => FluigIncludeObjectSchema.optional()), orderBy: z.union([FluigOrderByWithRelationInputObjectSchema, FluigOrderByWithRelationInputObjectSchema.array()]).optional(), where: FluigWhereInputObjectSchema.optional(), cursor: FluigWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FluigScalarFieldEnumSchema, FluigScalarFieldEnumSchema.array()]).optional() }).strict();