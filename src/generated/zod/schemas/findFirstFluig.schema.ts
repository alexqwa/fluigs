...
export const FluigFindFirstSelectSchema: z.ZodType<Prisma.FluigSelect> = z.object({
...
export const FluigFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    status: z.boolean().optional(),
    product: z.boolean().optional(),
    code: z.boolean().optional(),
...
export const FluigFindFirstSchema: z.ZodType<Prisma.FluigFindFirstArgs> = z.object({ select: FluigFindFirstSelectSchema.optional(), include: z.lazy(() => FluigIncludeObjectSchema.optional()), orderBy: z.union([FluigOrderByWithRelationInputObjectSchema, FluigOrderByWithRelationInputObjectSchema.array()]).optional(), where: FluigWhereInputObjectSchema.optional(), cursor: FluigWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FluigScalarFieldEnumSchema, FluigScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FluigFindFirstArgs>;

export const FluigFindFirstZodSchema = z.object({ select: FluigFindFirstSelectSchema.optional(), include: z.lazy(() => FluigIncludeObjectSchema.optional()), orderBy: z.union([FluigOrderByWithRelationInputObjectSchema, FluigOrderByWithRelationInputObjectSchema.array()]).optional(), where: FluigWhereInputObjectSchema.optional(), cursor: FluigWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FluigScalarFieldEnumSchema, FluigScalarFieldEnumSchema.array()]).optional() }).strict();