...
export const ImportLogFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ImportLogSelect> = z.object({
...
export const ImportLogFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    filename: z.boolean().optional(),
    status: z.boolean().optional(),
    totalRows: z.boolean().optional(),
...
export const ImportLogFindFirstOrThrowSchema: z.ZodType<Prisma.ImportLogFindFirstOrThrowArgs> = z.object({ select: ImportLogFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([ImportLogOrderByWithRelationInputObjectSchema, ImportLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: ImportLogWhereInputObjectSchema.optional(), cursor: ImportLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ImportLogScalarFieldEnumSchema, ImportLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ImportLogFindFirstOrThrowArgs>;

export const ImportLogFindFirstOrThrowZodSchema = z.object({ select: ImportLogFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([ImportLogOrderByWithRelationInputObjectSchema, ImportLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: ImportLogWhereInputObjectSchema.optional(), cursor: ImportLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ImportLogScalarFieldEnumSchema, ImportLogScalarFieldEnumSchema.array()]).optional() }).strict();