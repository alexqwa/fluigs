...
export const ImportLogFindFirstSelectSchema: z.ZodType<Prisma.ImportLogSelect> = z.object({
...
export const ImportLogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    filename: z.boolean().optional(),
    status: z.boolean().optional(),
    totalRows: z.boolean().optional(),
...
export const ImportLogFindFirstSchema: z.ZodType<Prisma.ImportLogFindFirstArgs> = z.object({ select: ImportLogFindFirstSelectSchema.optional(),  orderBy: z.union([ImportLogOrderByWithRelationInputObjectSchema, ImportLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: ImportLogWhereInputObjectSchema.optional(), cursor: ImportLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ImportLogScalarFieldEnumSchema, ImportLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ImportLogFindFirstArgs>;

export const ImportLogFindFirstZodSchema = z.object({ select: ImportLogFindFirstSelectSchema.optional(),  orderBy: z.union([ImportLogOrderByWithRelationInputObjectSchema, ImportLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: ImportLogWhereInputObjectSchema.optional(), cursor: ImportLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ImportLogScalarFieldEnumSchema, ImportLogScalarFieldEnumSchema.array()]).optional() }).strict();